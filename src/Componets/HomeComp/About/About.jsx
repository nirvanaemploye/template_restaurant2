...
import BaPolygon from "../../../assets/HomePngImg/polygon.png";
import Vector from "../../../assets/HomePngImg/Vector_Shape.png";
...
const About = ({ handlePopup }) => {
  ...
  return (
    <section
      style={bgStyle}
      className="py-32 relative flex justify-center text-ellipsis"
    >
      {/* Background Wave */}
      <div className="absolute top-0 z-0">
        <img src={Vector} alt="Decorative Wave" className="mx-auto" />
      </div>
